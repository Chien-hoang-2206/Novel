    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data) {
          ...
          setReload(true);
          console.log(response.data)
          window.location.href = `/novel/${novelID}`; // Thay đổi đường dẫn tương ứng
        ...
        <div key={reload}>
          <form onSubmit={handleSubmit}  >
            <UserEditNote className="mx-auto">
              ...
              ></textarea>
              <button  style={{ position: "relative",  top: -35, left: 300 }} type="submit">
                <span>
                  Đăng
                </span>
              </button>
          ...
          <div className="px-2 " style={{ marginTop: -70 }}>
