      ...
      <>
        <div className="flex h-20 px-3 items-center justify-center ">
          ...
          <div className="w-2/12 flex items-center" onClick={handleClick}>
            <i
              style={{ fontSize: 18, alignItems: "flex-end" }}
              ...
              <ul className=" items-center  text-base flex nav-menu">
                <li>
                  <div className="dropdown ">
                    <NavBtnLink to="/types">Thể loại</NavBtnLink>
            ...
            {showPostNewnovel && (
              <div className="flex justify-end w-5/12">
                {loggedIn ? (
                  ...
                  <div className="flex">
                    <NavBtnLink
                      to="/post-novel/post-new-novel"
                      onClick={handleLoginClick}
                    >
                      Đăng Truyện
                    </NavBtnLink>
                    <NavBtnLink className="px-2" onClick={handleLoginClick}>
                      Đăng nhập
                    </NavBtnLink>
                  </div>
                )}
